...
function AddForm({ isOpen, onClose, onAdd }: AddFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onAdd({
      ...
      profileImg: form.profileImg || "https://via.placeholder.com/150",
      isMe: false
    });
  ...
  return (
    <section className="form-container">
      <form onSubmit={handleSubmit}>
        <button type="button" className="btn-random-fill" onClick={handleRandomFill}>
          🎲 랜덤 값 채우기
        </button>
        ...
        <div className="form-grid">
          ...
          <div className="form-group full">
            ...
            <input type="text" name="skills" value={form.skills} onChange={handleChange} placeholder="React, TypeScript, CSS" required />
          </div>
          <div className="form-group full">
            <label>한 줄 소개</label>
